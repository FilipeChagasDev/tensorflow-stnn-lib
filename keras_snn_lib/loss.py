...
def triplet_loss(y_true: tf.Tensor, y_pred: tf.Tensor, margin: float = 0.1) -> tf.Tensor:    
    ...
    :param margin: desired separation margin between positive and negative examples, defaults to 0.1
